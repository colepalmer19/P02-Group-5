...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $area_of_expertise = htmlspecialchars($_POST['area_of_expertise']);
    $age = (int)$_POST['age'];
    ...
    if ($stmt->execute()) {
        ...
        // ✅ Step 4: Assign projects if any were selected
        ...
        <div class="create-container">
            ...
            <form method="POST" action="create_user.php" class="add-equipment-form">
                ...
                <div class="form-group">
                    ...
                    <select id="assigned_projects" name="assigned_projects[]" multiple required>
