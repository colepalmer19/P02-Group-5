...
if (!isset($_SESSION['session_userid']) || !isset($_SESSION['session_role']) || $_SESSION['session_role'] !== 'Researcher') {
            ...
            <table class="equipment-table">
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='researcher_update_user.php?id=" . urlencode($row['id']) . "'>Update</a></td>";
                        echo "</tr>";
                    }
