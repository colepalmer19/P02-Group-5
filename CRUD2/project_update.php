...
// Check if the user is authorized (Admin or Researcher)
if (!isset($_SESSION['session_userid']) || !in_array($_SESSION['session_role'], ['Admin', 'Researcher'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: view_projects.php"); // Redirect to project listing page
        exit();
    } else {
...
<body>
    ...
    <div class="top-bar">
        ...
        <a href="view_projects.php" class="home-btn">Cancel</a>
    </div>
